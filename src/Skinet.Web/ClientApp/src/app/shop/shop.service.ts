...
export class ShopService {
  ...
  getProducts(useCache = true): Observable<Pagination<Product[]>> {
    ...
    return this.http.get<Pagination<Product[]>>('products', {params}).pipe(
      map(response => {
  ...
  getBrands() {
    ...
    return this.http.get<Brand[]>('products/brands').pipe(
  ...
  getTypes() {
    ...
    return this.http.get<Type[]>('products/types').pipe(
